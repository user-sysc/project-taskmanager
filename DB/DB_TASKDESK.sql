...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_ID_TAREA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_ID_USUARIO
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_ID_USUARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index PK_ID_USUARIOS
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_ID_USUARIOS" ON "USUARIOS" ("ID_USUARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index PK_ID_CATEGORIA
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_INCREMENTO_TAREAS" 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_INCREMENTO_USUARIOS" 
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "CONSULTARTAREAS" (
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "CONSULTARUSUARIOS" (resultados OUT SYS_REFCURSOR)
AS
BEGIN
  OPEN resultados FOR
    SELECT
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_CAMBIARESTADOTAREA" (t_id_tarea IN NUMBER, t_nuevo_estado IN VARCHAR2)
AS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_ELIMINARTAREA" (
    t_id_task IN NUMBER,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_ELIMINARTAREASCOMPLETAS" (
    t_id_usuario IN NUMBER
)
AS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_FILTRARTAREASPORFECHA" (
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_GET_ID_USUARIO" (
    u_email IN VARCHAR2,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_INSERTARTAREA" (
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_INSERTARUSER" (    
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_VALIDAREMAIL" (
    u_email IN VARCHAR2,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_VALIDARUSUARIO" (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_TAREAS_PRC" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_TAREAS_PRC" AS
...
--------------------------------------------------------
  ...
  ALTER TABLE "USUARIOS" ADD CONSTRAINT "PK_ID_USUARIOS" PRIMARY KEY ("ID_USUARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
