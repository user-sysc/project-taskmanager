--------------------------------------------------------
-- Archivo creado  - jueves-noviembre-30-2023   
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_ID_TAREA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 161 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into TAREAS (ID_TAREA,DESCRIPCION,FECHA_FINALIZADO,ESTADO,ID_CATEGORIA,ID_USUARIO) values ('141','TALLER CALCULO',to_date('04/12/23','DD/MM/RR'),'PENDING','1','1');
REM INSERTING into USUARIOS
SET DEFINE OFF;
Insert into USUARIOS (ID_USUARIO,USUARIO,EMAIL,CLAVE) values ('1','user-sysc','user@gmail.com','1234');
--------------------------------------------------------
